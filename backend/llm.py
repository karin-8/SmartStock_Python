...
def summarize_analytics(analytics: dict) -> str:
    ...
    prompt = ChatPromptTemplate.from_template("""
        ...
        - ให้ insight ที่เป็นประโยชน์กับคนหน้างาน (ที่ไม่มีความรู้สถิติ) ไม่ต้องโชว์ข้อมูลดิบ
        - ตอบกลับในรูปแบบ **Markdown** โดยมี 3 หัวข้อ:

        
        ## สินค้ามาแรง
        - แสดงรายการ SKU ที่มี slope ความต้องการสูงสุด 5 รายการ (บอกอันดับด้วย)
        - สรุปท้ายรายการ เช่นสาเหตุที่เป็นไปได้

        ## สินค้าเสี่ยงของขาด
        - แสดงรายการ SKU ที่มี slope สต็อกต่ำลงเร็วที่สุด 5 รายการ (บอกอันดับด้วย)
        - สรุปท้ายรายการ เช่นสาเหตุที่เป็นไปได้
        ## คำแนะนำเชิงกลยุทธ์
